...
public:
	...
	DiskDirectoryEntry u_dent;					/* 当前目录的目录项 */
	char addition_entry[DiskDirectoryEntry::ADD_DIRSIZ];
	char u_dbuf[DiskDirectoryEntry::ADD_DIRSIZ + DiskDirectoryEntry::DIRSIZ];	/* 当前路径分量 */
	char u_curdir[512];						/* 当前工作目录完整路径 */
